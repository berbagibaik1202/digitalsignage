...
Media uploaded through the dashboard is served from `https://md.display.rizki-tech.com` by default. To use another VPS or custom domain, set `MINIO_PUBLIC_URL` in `.env` to that browser-accessible MinIO URL.
